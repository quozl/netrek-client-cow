...
#endif /* SOUND */
/*
 * Fri Dec 19 21:55:05 CET 2008  stefan <stefan@rent-a-guru.de>
 *
 *	- Added support for sound on SGI systems (see also audio.c).
 *
 *	- Added new sound files for the effects.
 *
 *	- Clened up code somewhat.
 *
 *
 * $Log: sound.c,v $
